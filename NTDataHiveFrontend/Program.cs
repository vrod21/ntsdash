...
builder.Services.AddSingleton<EmployeeBackendService>();
builder.Services.AddSingleton<PreEditingFeedbackBackendService>();
builder.Services.AddSingleton<RevisionBackendService>();
